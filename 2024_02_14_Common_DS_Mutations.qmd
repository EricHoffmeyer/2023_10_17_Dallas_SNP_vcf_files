...
```{r}
vcfR.full.inExon.gr = vcfR.full.vcf.gr|>filter_by_overlaps(TxDb.exonsBy.gene)
```

## Annotate

```{r}
vcfR.full.inExon.anno = annotatePeak(vcfR.full.inExon.gr,
                                     tssRegion = c(-10, 10),
                                     TxDb = TxDb,
                                     annoDb = "org.Hs.eg.db")
vcfR.full.inExon.anno@anno
```
